...
function initEdit(studentId) {
    ...
    document.getElementById("year").value = studentManagement[index].year;
    ...
    if (studentManagement[index].sex == "danghoc") {
        document.getElementById("danghoc").value = "Đang Học";
    } else if(studentManagement[index].sex == "cholop"){
        document.getElementById("cholop").value = "Chờ lớp";
    } else if(studentManagement[index].sex == "baoluu"){
        document.getElementById("baoluu").value = "Bảo lưu";
    } else if(studentManagement[index].sex == "dinhchi"){
        document.getElementById("dinhchi").value = "Đình chỉ";
    } else {
        document.getElementById("totnghiep").value = "Tốt nghiẹp";
    }
    // 4. Đặt lại cờ
    action = "Edit";
}
